...
"""
                ...
                if d > 6:
                    if self.dir_list[d - 1] != self.dir_list[d - 2]:
                        ...
                        if self.dir_list[d - 1] != self.dir_list[d - 2]:
                            if self.dir_list[d - 1] == "UP":
                                if self.dir_list[d - 2] == "RIGHT":
                                    self.level.direction_change_tile_right_up( self.rect.center, self.rect.topleft,
                                                                               self.rect.topright, self.rect.bottomleft,
                                                                               self.rect.bottomright )

                        if self.dir_list[d - 1] != self.dir_list[d - 2]:
                            if self.dir_list[d - 1] == "DOWN":
                                if self.dir_list[d - 2] == "LEFT":
                                    self.level.direction_change_tile_left_down( self.rect.center, self.rect.topleft,
                                                                              self.rect.topright, self.rect.bottomleft,
                                                                              self.rect.bottomright )
                        ...
                        if self.dir_list[d - 1] != self.dir_list[d - 2]:
                            if self.dir_list[d - 1] == "DOWN":
                                if self.dir_list[d - 2] == "RIGHT":
                                    self.level.direction_change_tile_right_down( self.rect.center, self.rect.topleft,
                                                                              self.rect.topright, self.rect.bottomleft,
                                                                              self.rect.bottomright )
