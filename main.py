...
def main():
    ...
    while running:
        ...
        def game_loop(timer, current_level, player, path_maker):
            ...
            for event in pygame.event.get():
                ...
                # and program both.
                if event.type == pygame.USEREVENT and timer.counter > -1:
                    timer.clock_tick()
                ...
                if event.type == BOMBTIMEREVENT and current_level.foreground.bt.bcounter > -1:
                ...
                if event.type == KEYDOWN:
                    ...
                    if player.pathmaker == True and player.belowground == True:
                        ...
                        player_movement(event, player, path_maker)
                    if event.key == K_SPACE and current_level.bomb_num > -1:
                        b = Bomb()
                        ...
                        pygame.time.set_timer(BOMBTIMEREVENT, 999)
